...
import com.frederikzwartbol.kata.kyu7.theoffice.TheOffice.Person;
...
public class TheOfficeTest {
    @Test
    public void basic1() {
        TheOffice.Person[] meet = new TheOffice.Person[]{
                new TheOffice.Person("tim", 0),
                new TheOffice.Person("jim", 2),
                new Person("randy", 0),
                new Person("sandy", 7),
                new Person("andy", 0),
                new Person("katie", 5),
